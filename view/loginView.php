...
<html lang="en">
    <head>
        ...
        <link href="public/assets/css/transparent/app.min.css" rel="stylesheet" />
        <!-- ================== END BASE CSS STYLE ================== -->
        ...
        <!-- FAVICONS -->
        <link rel="shortcut icon" href="public/assets/img/logito.png" type="image/x-icon">
        <link rel="icon" href="public/assets/img/logito.png" type="image/x-icon">
    </head>
    <body class="pace-top">
        ...
        <div class="login-cover">
            <div class="login-cover-image" style="background-image: url(public/assets/img/fondo2.png)" data-id="login-cover-image"></div>
        ...
        <div id="page-container" class="fade page-container">
            ...
            <div class="login login-v2" data-pageload-addclass="animated fadeIn">
                ...
                <div class="login-header ">
                    ...
                    <div class="icon">
                        <img src="public/assets/img/LOGO.png" width="150" height="150" alt="Sincronizador QBO-MH"/>
                    </div>
                </div>
                <!-- end brand -->
        ...
        <script src="public/assets/js/theme/transparent.min.js"></script>
        <!-- ================== END BASE JS ================== -->
        ...
        <script src="public/assets/plugins/sweetalert/dist/sweetalert.min.js"></script>
        <script src="public/assets/js/demo/ui-modal-notification.demo.js"></script>
        <!-- ================== END PAGE LEVEL JS ================== -->
        <?php
        if (isset($_GET["error"])) {
            if($_GET["error"] == "1"){
